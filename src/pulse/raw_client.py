        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                "fileUrl": file_url,
                "model": model,
                "extractionConfigId": extraction_config_id,
                "pages": pages,
                "async": async_,
            ...
            files={
                ...
                **(
                    {"extensions": (None, json.dumps(jsonable_encoder(extensions)), "application/json")}
                    if extensions is not OMIT
                    else {}
                ),
                **(
                    {"spreadsheet": (None, json.dumps(jsonable_encoder(spreadsheet)), "application/json")}
                    if spreadsheet is not OMIT
                    else {}
                ),
                **(
                    {"storage": (None, json.dumps(jsonable_encoder(storage)), "application/json")}
                    if storage is not OMIT
                    else {}
                ),
                **(
                ...
                **(
                    {"schema": (None, json.dumps(jsonable_encoder(schema)), "application/json")}
                    if schema is not OMIT
                    else {}
                ),
            },
