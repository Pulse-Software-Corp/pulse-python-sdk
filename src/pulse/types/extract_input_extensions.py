...
class ExtractInputExtensions(UncheckedBaseModel):
    """
    ...
    chunking: typing.Optional[ExtractInputExtensionsChunking] = pydantic.Field(default=None)
    """
    ...
    alt_outputs: typing_extensions.Annotated[
        typing.Optional[ExtractInputExtensionsAltOutputs], FieldMetadata(alias="altOutputs")
    ] = pydantic.Field(default=None)
    """
