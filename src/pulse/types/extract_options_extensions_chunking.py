...
class ExtractOptionsExtensionsChunking(UncheckedBaseModel):
    """
    ...
    chunk_types: typing_extensions.Annotated[
        typing.Optional[typing.List[ExtractOptionsExtensionsChunkingChunkTypesItem]], FieldMetadata(alias="chunkTypes")
