...
class ExtractRequestExtensions(UncheckedBaseModel):
    """
    ...
    chunking: typing.Optional[ExtractRequestExtensionsChunking] = pydantic.Field(default=None)
    """
    ...
    alt_outputs: typing_extensions.Annotated[
        typing.Optional[ExtractRequestExtensionsAltOutputs], FieldMetadata(alias="altOutputs")
    ] = pydantic.Field(default=None)
    """
