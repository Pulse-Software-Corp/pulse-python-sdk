...
class ExtractResultCoreExtensionsAltOutputs(UncheckedBaseModel):
    """
    Alternate output formats. Each key corresponds to an enabled alt output.
    """

    wlbb: typing.Optional[ExtractResultCoreExtensionsAltOutputsWlbb] = pydantic.Field(default=None)
    """
