...
class ExtractResultCoreExtensionsAltOutputsWlbb(UncheckedBaseModel):
    """
    Word-level bounding box data. Present when `extensions.altOutputs.wlbb` was enabled and input is a PDF.
    """

    words: typing.Optional[typing.List[ExtractResultCoreExtensionsAltOutputsWlbbWordsItem]] = pydantic.Field(
        default=None
    )
    """
