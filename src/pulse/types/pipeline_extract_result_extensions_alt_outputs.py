...
class PipelineExtractResultExtensionsAltOutputs(UncheckedBaseModel):
    """
    Alternate output formats. Each key corresponds to an enabled alt output.
    """

    wlbb: typing.Optional[PipelineExtractResultExtensionsAltOutputsWlbb] = pydantic.Field(default=None)
    """
