...
class PipelineExtractResultExtensionsAltOutputsWlbb(UncheckedBaseModel):
    """
    Word-level bounding box data. Present when `extensions.altOutputs.wlbb` was enabled and input is a PDF.
    """

    words: typing.Optional[typing.List[PipelineExtractResultExtensionsAltOutputsWlbbWordsItem]] = pydantic.Field(
        default=None
    )
    """
