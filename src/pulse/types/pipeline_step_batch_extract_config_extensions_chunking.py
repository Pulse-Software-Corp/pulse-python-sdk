...
class PipelineStepBatchExtractConfigExtensionsChunking(UncheckedBaseModel):
    """
    ...
    chunk_types: typing_extensions.Annotated[
        typing.Optional[typing.List[PipelineStepBatchExtractConfigExtensionsChunkingChunkTypesItem]],
